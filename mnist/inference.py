...
def test_on_random_samples(model, device, num_samples=5):
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT / 'mnist/random_samples_test.png',
                dpi=150, bbox_inches='tight')
    print(f"\nTested on {num_samples} random samples")
    print(
        f"Accuracy: {correct}/{num_samples} ({100*correct/num_samples:.1f}%)")
    print("Results saved to outputs/mnist/random_samples_test.png")
...
def main():
    ...
    # Load model
    model_path = OUTPUT /'mnist/best_mnist_model.pth'
