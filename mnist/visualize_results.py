...
from common.paths import OUTPUT

def plot_training_history(checkpoint_path=OUTPUT / 'mnist/final_mnist_model.pth'):
    """
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT / 'mnist/training_history.png',
                dpi=150, bbox_inches='tight')
    print("Training history plot saved to outputs/mnist/training_history.png")
...
def plot_confusion_matrix(model_path=OUTPUT / 'mnist/best_mnist_model.pth'):
    """
    ...
    plt.title('Confusion Matrix - MNIST Test Set',
              fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig(OUTPUT / 'mnist/confusion_matrix.png',
                dpi=150, bbox_inches='tight')
    print("Confusion matrix saved to outputs/mnist/confusion_matrix.png")
...
def visualize_filters(model_path=OUTPUT / 'mnist/best_mnist_model.pth'):
    """
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT / 'mnist/conv_filters.png', dpi=150, bbox_inches='tight')
    print("Convolutional filters visualization saved to outputs/mnist/conv_filters.png")


def analyze_misclassifications(model_path=OUTPUT / 'mnist/best_mnist_model.pth', num_examples=20):
    """
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT / 'mnist/misclassifications.png',
                dpi=150, bbox_inches='tight')
    print(f"Found {len(misclassified)} misclassified examples")
    print("Misclassifications visualization saved to outputs/mnist/misclassifications.png\n")
